...
public class Cad_Cli extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
            inseriu = ctrlCliente.insereCliente(this.txtNome.getText(), this.txtCPF.getText(), this.jComboEstado.getSelectedItem(), this.txtCidade.getText(), this.txtRua.getText(), this.txtNum.getText(), this.txtBairro.getText(), this.txtCEP.getText());
            nome, cpf, telefone_cel, telefone, cidade, estado, cep, bairro, rua, numero, email
